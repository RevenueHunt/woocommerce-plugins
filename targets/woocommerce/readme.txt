...
Tags: quiz, product recommendation, woocommerce, sales automation, ecommerce
...
= 2.3.1 =
* Fix - Environment detection now only uses domain patterns, ensuring customers with WordPress in development mode connect to production API
